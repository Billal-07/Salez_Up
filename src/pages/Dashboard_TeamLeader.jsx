            ...
            <div className="flex justify-between w-full mb-4">
                ...
                <div className="space-y-4">
                    <div className="flex items-center space-x-14">
                        ...
                        <span className="text-[#7B7B7B] font-semibold text-[16px]"> {filteredAgents.length} FTE</span>
                    </div>
...
const Dashboard_TeamLeader = () => {
    ...
    const performanceData = [
        { kpi: 'Revenue', target: '$80,000', actual: '$40,000', percentToTarget: 50, commission: '$250', gatekeeper: 'YES', gatekeeperTarget: '60%' },
