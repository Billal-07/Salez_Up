                    ...
                    <div className="flex flex-wrap justify-center mt-10">
                        ...
                        <div className="m-3">
                            <a title="Super Admin Panel"
                                href="https://salez-up.vercel.app/TeamLeader/4q7Z1Y2f" target='_blank'
                                className="inline-flex items-center h-16 px-6 py-2 font-bold tracking-wide text-center text-[#269F8B] bg-white border-2 border-[#269F8B] rounded shadow-md md:w-56 hover:border-gray-600 hover:bg-[#269F8B] hover:text-white">
                        ...
                        <div className="m-3">
                            <a title="Super Admin Panel"
                                href="https://salez-up.vercel.app/SalesAgent/x9y8z7g3" target='_blank'
                                className="inline-flex items-center h-16 px-6 py-2 font-bold tracking-wide text-center text-[#269F8B] bg-white border-2 border-[#269F8B] rounded shadow-md md:w-56 hover:border-gray-600 hover:bg-[#269F8B] hover:text-white">
                        ...
                        <div className="m-3">
                            <a title="Super Admin Panel"
                                href="https://salez-up.vercel.app/OpsManager_SignIn/vH0kx3Lq5JS8" target='_blank'
                                className="inline-flex items-center h-16 px-6 py-2 font-bold tracking-wide text-center text-[#269F8B] bg-white border-2 border-[#269F8B] rounded shadow-md md:w-56 hover:border-gray-600 hover:bg-[#269F8B] hover:text-white">
