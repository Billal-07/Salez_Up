            ...
            <div className="flex flex-wrap items-center justify-between gap-2 sm:gap-3 lg:justify-start">
              {/* {teams.map((team, index) => (
                <div key={index} className="">
                  <p className="min-w-[100px] sm:min-w-[124px] px-2 sm:px-3 h-[35px] sm:h-[41px] flex items-center justify-center text-[15px] sm:text-[17px] leading-[22px] sm:leading-[25px] font-[400] rounded-[192px] bg-themeGreen text-white text-center">
                    {team}
                  </p>
                </div>
              ))} */}
