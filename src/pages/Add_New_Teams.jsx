...
//     try {
//       const existingTeamsResponse = await axios.get('https://crmapi.devcir.co/api/teams');
...
//       const teamResponse = await axios.post('https://crmapi.devcir.co/api/teams', {
//         team_name: teamName,
...
//       const teamsResponse = await axios.get('https://crmapi.devcir.co/api/teams');
//       const newTeamId = teamsResponse.data[teamsResponse.data.length - 1].id;
  
//       // console.log("New team ID:", newTeamId);
  
//       const teamLeaderResponse = await axios.post('https://crmapi.devcir.co/api/team_and_team_leader', {
//         team_id: newTeamId,
