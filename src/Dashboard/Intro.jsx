...
<div className="flex items-start gap-8">
          ...
          <h2 className="text-4xl text-gray-600 mt-6 "><span className="font-bold">Good Morning</span>, Nshali</h2>
...
<div className="relative mt-6">
  ...
  {/* Badge */}
  <div className="absolute top-20 left-24 w-[81px] h-[81px] rounded-full">
    <img
  ...
  <div className="absolute inset-0 flex flex-col justify-center items-center text-center">
    ...
    <h3 className="text-4xl font-semibold text-gray-600">Sarah Smart</h3>
    <button
      className="mt-4 px-10 py-2 text-white font-medium rounded-lg"
      style={{
        background: "linear-gradient(to right, #00d2ff, #7a00ff)",
      }}
    >
